...
namespace TaxCalculator.Test
{
    internal abstract class Helpers
    {
        ...
        internal static IEnumerable<TaxBand> CreateTaxBands()
        {
            ...
            {
                new TaxBand{ Id = 1, TaxRateCode = "FV0", LowerLimit = 0m, UpperLimit = 199999.99m, TaxTypeId = 1, IsActive = true},
                new TaxBand{ Id = 2, TaxRateCode = "FV1", LowerLimit = 200000.00m, TaxTypeId = 1, IsActive = true},
                new TaxBand{ Id = 3, TaxRateCode = "FR" , TaxTypeId = 2, IsActive = true},
                new TaxBand{ Id = 4, TaxRateCode = "P0", LowerLimit = 0, UpperLimit = 8350.99m, TaxTypeId = 3, IsActive = true},
                new TaxBand{ Id = 5, TaxRateCode = "P1", LowerLimit = 8351.00m, UpperLimit = 33950.99m, TaxTypeId = 3, IsActive = true},
                new TaxBand{ Id = 6, TaxRateCode = "P2", LowerLimit = 33951.00m, UpperLimit = 82250.99m, TaxTypeId = 3, IsActive = true},
                new TaxBand{ Id = 7, TaxRateCode = "P3", LowerLimit = 82251.00m, UpperLimit = 171550.99m, TaxTypeId = 3, IsActive = true},
                new TaxBand{ Id = 8, TaxRateCode = "P4", LowerLimit = 171551.00m, UpperLimit = 372950.99m, TaxTypeId = 3, IsActive = true},
